...
export const HomeTest = describe('HomeTest', () => {
    test('1차원 배열 -> 2차원 배열 변환', () => {
        ...
        const bestTouristAttractions = [];
        const originalArray = [...bestTouristAttractionInfos];

        while (bestTouristAttractionInfos.length) {
            bestTouristAttractions.push(bestTouristAttractionInfos.splice(0, 2));
        }
        ...
        expect(bestTouristAttractions.flat()).toEqual(originalArray);
    });
});
